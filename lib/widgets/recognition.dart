import 'dart:async';
import 'package:flutter_app1/services/tensorflow-service.dart';
...
class _RecognitionState extends State<Recognition> {
 ...
 double nguong=0;
      ...
      _streamSubscription = _tensorflowService.recognitionStream.listen((recognition) {
        if (recognition != null) {
          ...
          setState(() {
            ...
            nguong = _currentRecognition[0]['confidence'];
            print(nguong);
          });
        } else {
          _currentRecognition = [];
  ...
  Widget _contentWidget() {
    ...
    if (_currentRecognition.length > 0 && nguong >=0.8) {
      return Container(
        height: 150,
      ...
      return Text('Không xác định', style: TextStyle(fontSize: 30, fontWeight: FontWeight.w300, color: Colors.white),);
    }
  }
